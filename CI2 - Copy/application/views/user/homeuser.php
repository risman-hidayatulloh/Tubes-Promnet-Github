<div class="sidebar-menu">
	...
	<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
        <div class="menu">
			<ul id="menu" >
				<li class="<?php echo element('home',$status);?>"><a href="<?php echo site_url('HomeUserController'); ?>"><i class="lnr lnr-home"></i> <span>Home</span></a></li>
				<li class="<?php echo element('pembayaran',$status);?>"><a href="<?php echo site_url('HomeUserController/viewPembayaran'); ?>"><i class="lnr lnr-cart"></i> <span>Transaksi</span></a></li>
