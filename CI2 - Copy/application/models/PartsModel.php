<?php 
	...
	class PartsModel extends CI_Model{
		...
		public function getData(){
			return $this->db->query('SELECT parts.id_part,kode_part, nama_part, harga_ref_part, count(id_stok) as stok from parts, href_parts, stok_parts WHERE parts.id_part = href_parts.id_part and parts.id_part = stok_parts.id_part and stok_parts.status = 1 group by parts.id_part');
