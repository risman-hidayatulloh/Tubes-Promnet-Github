...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2018 at 04:03 AM
...
INSERT INTO `users` (`id_user`, `username`, `passwrod`, `jenis_user`) VALUES
(1, 'risman', 'risman', 123456),
(2, 'faris', 'faris', 123456);
...
--
ALTER TABLE `href_parts`
  MODIFY `id_href_part` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `parts`
  MODIFY `id_part` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
