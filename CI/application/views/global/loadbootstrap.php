...
<html lang="en">
	<head>
		...
		<!-- lined-icons -->
		<link rel="stylesheet" href="<?php echo base_url();?>asset/css/icon-font.min.css">
		<link rel="stylesheet" href="<?php echo base_url();?>asset/js/simpleCart.min.js">
		<link rel="stylesheet" href="<?php echo base_url();?>asset/js/amcharts.min.js">
		<link rel="stylesheet" href="<?php echo base_url();?>asset/js/serial.min.js">
		<link rel="stylesheet" href="<?php echo base_url();?>asset/js/light.min.js">
		<!-- //lined-icons -->
		<link rel="stylesheet" href="<?php echo base_url();?>asset/js/jquery-1.10.2.min.js">
